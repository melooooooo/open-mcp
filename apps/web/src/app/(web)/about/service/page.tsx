      ...
      <div className="max-w-4xl mx-auto py-6">
        ...
        <div className="prose prose-sm space-y-6">
          <section className="space-y-3">
            ...
            <p>
              本协议是您与银行帮平台（以下简称"本站"）之间关于使用平台服务所订立的协议。银行帮是一个免费、公益性质的银行求职信息整合与经验分享平台，由本站团队维护与运营。使用本站服务即表示您同意本协议的全部条款。
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              用户在平台上发布的原创内容（如面经、攻略等）仍归用户所有，但用户授予银行帮平台在站内展示、推广及必要编辑的权利。
            </p>
          </section>
